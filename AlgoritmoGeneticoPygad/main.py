...
class BuzzleApp(kivy.app.App):
    ...
    def initialize_population(self, *args):
        ...
        print('self.population_1D_vector', self.population_1D_vector)
    ...
    def update_board_UI(self, *args):
        ...
        self.num_attacks_Label.text = str(self.ga_instance.generations_completed) + " " + str(
            numpy.round(max_fitness, 4))
